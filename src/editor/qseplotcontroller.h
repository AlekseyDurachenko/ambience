...
#ifndef QSEPLOTCONTROLLER_H
#define QSEPLOTCONTROLLER_H
...
class QsePlotController : public QseAbstractController
{
    Q_OBJECT
public:
    explicit QsePlotController(QObject *parent = 0);
    ...
    void wheelEvent(QWheelEvent *event, const QRect &rect, const QseGeometry &geometry);
signals:
...
QseCursor *QsePlotController::position()
{
    return m_position;
}

QseSelection *QsePlotController::selection()
{
    return m_selection;
}


#endif // QSEPLOTCONTROLLER_H

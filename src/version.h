...
const int g_versionMonth = 8;
const int g_verstionDay  = 15;
const char g_versionStatusShort[]    = "dev";
const char g_programName[]   = "Ambience";
const char g_projectFamily[] = "qaudiotools";
const char g_projectName[]   = "Ambience";

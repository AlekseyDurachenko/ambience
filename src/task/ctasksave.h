...
class CTaskSave : public CAbstractTask
{
    Q_OBJECT
public:
    explicit CTaskSave(QObject *parent = 0);
...
signals:
    ...
    void done();
private slots:
    void privateWrite(const QString &fileName, QSharedPointer<CSound> sound, int format, qint64 start, qint64 end);
private:
